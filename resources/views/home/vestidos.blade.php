...
<section class="section-slide">
	<div class="wrap-slick1">
		<div class="slick1">
			<div class="item-slick1" style="background-image: url(images/blog-06.jpg);">
					...
					<a href="#" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							...
							<span class="block1-info stext-102 trans-04">
								¡Imprima tantas plantillas de hojas para colorear como desee, diseñelas de la forma que pueda
								imaginar!
							</span> <br>
						</div>
				...
				<div class="block1 wrap-pic-w" style="background-color:#f61d4863;font-weight: bold;">
					...
					<a href="#" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							...
							<span class="block1-info stext-102 trans-04">
								Cargue una fotografía en su teléfono inteligente bien iluminada de su increíble obra de arte
								aquí en nuestro sitio para realizar su pedido.
							</span>
						</div>
				...
				<div class="block1 wrap-pic-w" style="background-color:#95ff0045;font-weight: bold;">
					...
					<a href="#" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							...
							<span class="block1-info stext-102 trans-04">
								¡Prepárate para hacer vibrar tu creación única y demostrarle al mundo que eres verdaderamente
								único!
							</span> <br>
						</div>
...
<center>
<img style="width: 15%;" src="images/printer.svg" alt="IMG-BANNER">

	<div class="p-b-10">
		<h3 style="color:#de4b7d;font-size: 30px;" class="ltext-103 cl5" style="text-align: center">
			Imprime tus plantillas de vestir para colorear y empieza!
		</h3>
	</div>

	<div style="width: 40%;" class="size-204 respon6-next">
		<div class="rs1-select2 bor8 bg0">
			<select class="js-select2" name="time">
				<option>Elegir el tipo de vestido</option>
